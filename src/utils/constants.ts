...
export const citeLinkStatic = "<span data-type=\"block-ref\" custom-cite-type=\"citep\" data-id=\"${id}\" data-subtype=\"s\">${link}</span>";
export const citeLinkDynamic = "<span data-type=\"block-ref\" custom-cite-type=\"citep\" data-id=\"${id}\" data-subtype=\"d\">${link}</span>";
